...
<html lang="zh-Hant-TW">
    ...
    <body>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        <tr class="odd gradeX">
                                            <td>
                                                <button type="button" class="btn-primary" data-toggle="modal" data-target="#orderformModal<?php echo $row_paging[0];?>">
                                                    修改
                                                </button>  
                                                <button type="button" class="btn-danger" data-toggle="modal" data-target="#deleteOrderform<?php echo $row_paging[0];?>">
                                                    刪除
                                                </button> 
                                            </td>
                                            <td><a href="detail.php?orderform=<?php echo $row_paging[0]?>"><?php echo $row_paging[0]?></a></td>
                                            <td><?php echo $row_paging[1]?></td>
                                            <td><?php echo $row_paging[2]?></td>
                                            <td><?php echo $row_paging[3]?></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
        ...
        <?php 
            ...
            <!-- 修改訂單的Modal -->
            <div class="modal fade" id="orderformModal<?php echo $row_update[0];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <form method="post" action="../controllers/actionOrderform.php">
                            ...
                            <div class="modal-body">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr>
                                            <input style="visibility:hidden" name="update_orderformID" value="<?php echo $row_update[0];?>"/>
                                            <input style="visibility:hidden" name="update_clientName" value="<?php echo $row_update[1];?>"/>
                                            <td><?php echo $row_update[0];?></td>
                                            <td><?php echo $row_update[1];?></td>
                                            <td>
                                                <input type="text" name="update_deadline" value="<?php echo $row_update[2];?>"></input>
                                            </td>
                                            <td>
                                                <input type="text" name="update_total" value="<?php echo $row_update[3];?>"></input>
                                            </td>
                                        </tr>    
                                    </tbody>
                                </table>
        ...
        <?php 
            ...
            <!-- 刪除訂單的Modal -->
            <div class="modal fade bs-example-modal-sm" id="deleteOrderform<?php echo $row_delete[0];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="post" action="../controllers/actionOrderform.php">
                            ...
                            <div class="modal-body">
                                訂單編號：<?php echo $row_delete[0];?><br>
                                案名：<?php echo $row_delete[1];?>
                            </div>
                            <div class="modal-footer">    
                                <input style="visibility:hidden" name="delete_orderformID" value="<?php echo $row_delete[0];?>"/>
